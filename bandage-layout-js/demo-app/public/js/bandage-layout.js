async function createBandageLayoutModule(moduleArg = {}) {
  var moduleRtn
  ...
  function findWasmBinary() {
    if (Module['locateFile']) {
      return locateFile('bandage-layout.wasm')
    }
    return new URL('bandage-layout.wasm', import.meta.url).href
  }
